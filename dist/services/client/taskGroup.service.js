...
const countDocuments = (_a) => __awaiter(void 0, [_a], void 0, function* ({ filter, }) {
    return yield taskGroup_model_1.default.countDocuments(Object.assign({ deleted: false }, filter));
});
const find = (_a) => __awaiter(void 0, [_a], void 0, function* ({ filter, select, sort, skip, limit, }) {
    return yield taskGroup_model_1.default.find(Object.assign({ deleted: false }, filter))
        .select(select || "")
        .sort(sort)
        .skip(skip || 0)
        .limit(limit || 20);
